...
const glassesCollection = [
    ...
    { id: 16, icons: g15, name: 'FORMAL', text: 'Mens Leathers Formal Wear shoes Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti fuga illo repellat.', rate: 50.00, delete: 65.00 },
]
